  ...
  return (
    <div>
      <TextArea
        ...
        onPressEnter={commit}
        onChange={InputText}
        style={{ width: "600px", radius: "30" }}
      />
      <Button
        style={{ backgroundColor: "green", border: "none", height: 55 }}
        type="primary"
        onClick={commit}
      >
        Enter
            ...
            <div>
              ...
              {item.writer.userEmail === profile ? (
                <div style={{ marginLeft: "70%", marginTop: "20px" }}>
                  <a
                    onClick={() => modify(item.rp_num)}
                    style={{ marginRight: 30 }}
                  >
                    MODIFY
                  </a>
                  <a onClick={() => delet(item.rp_num)}>DELETE</a>
                </div>
              ) : (
                ""
              )}
          ...
          {modi && modinum === item.rp_num ? (
            <div style={{ width: "500px", display: "flex", gap: 30 }}>
              ...
              <Button
                style={{ backgroundColor: "green", border: "none", height: 55 }}
                type="primary"
                onClick={() => handleFocus(item.rp_num)}
              >
                MODIFY
              </Button>
            </div>
