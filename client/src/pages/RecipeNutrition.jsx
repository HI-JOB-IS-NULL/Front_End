...
export  default function RecipeNutrition(){
    ...
    const myUploader = (event) => {
        ...
        // console.log(formData.getAll('uploadFiles'));
          axios({
            method: 'POST',
            url: `${kServerIP}/RecipeDB/nser/fooImageDetectionNutritionalInfo`,
            data: formData,
            headers: {
            ...
            if (res.status === 200) {
              ...
              setBasicData({labels: ['Calcium', 'Carbs', 'Fat', 'Cholesterol', 'Protein'],
              datasets: [
                  {
                      label: 'My First dataset',
                      backgroundColor: '#42A5F5',
                      data: [nu.CA.quantity, nu.CHOCDF.quantity, nu.FAT.quantity,nu.CHOLE.quantity, nu.PROCNT.quantity]
                  },
                  {
    ...
    return (
        <Box sx={{ width: 'auto', typography: 'body1', marginTop:'120px'}}>
            ...
            <div > 
                <FileUpload ref={fileUploadRef} name="demo[]" url="./upload" multiple accept="image/*" maxFileSize={1000000}
                    onUpload={onTemplateUpload} onSelect={onTemplateSelect} onError={onTemplateClear} onClear={onTemplateClear}
                    headerTemplate={headerTemplate} itemTemplate={itemTemplate} emptyTemplate={emptyTemplate} onRemove={onRemoveClear}
                    chooseOptions={chooseOptions} uploadOptions={uploadOptions} cancelOptions={cancelOptions} customUpload uploadHandler={myUploader} />
            </div>
